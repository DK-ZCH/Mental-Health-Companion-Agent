...
public class XinlilaoshiCollectionView extends XinlilaoshiCollectionEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 类型的值
		*/
		private String favoriteTypeLabel;
	...
	public XinlilaoshiCollectionView(XinlilaoshiCollectionEntity xinlilaoshiCollectionEntity) {
		try {
			...
			* 获取： 类型的值
			*/
			public String getFavoriteTypeLabel() {
				return favoriteTypeLabel;
			}
			/**
			* 设置： 类型的值
			*/
			public void setFavoriteTypeLabel(String favoriteTypeLabel) {
				this.favoriteTypeLabel = favoriteTypeLabel;
			}
