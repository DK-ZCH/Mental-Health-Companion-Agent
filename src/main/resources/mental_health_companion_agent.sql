...
-- 表数量     : 16
-- 适用版本   : MySQL 8.0+
-- 来源       : 由原 db.sql（SQLyog 导出）规范化整理
-- 整理日期   : 2026-09-22
-- -----------------------------------------------------------------------------
-- 规范化内容
--   1. 数据库名统一为 mental_health_companion_agent（与脚本文件同名）
--   2. 字符集由 utf8 升级为 utf8mb4，并显式指定 utf8mb4_general_ci
--   3. 补充 DROP DATABASE IF EXISTS 与显式 CREATE DATABASE
--   4. 移除 SQLyog 头部横幅与 /*!4xxxx SET @OLD_* */ 条件注释
--   5. 统一注释风格：清除代码生成器残留标记（Search111 / show1 / show2 /
--      show3 / photoShow / nameShow），去掉注释尾部多余空格
--   6. 统一关键字大小写（INSERT INTO）与章节分隔头
-- 保持不变
--   表名、字段名、字段顺序、字段类型（含显示宽度）、NULL/NOT NULL、
--   DEFAULT、AUTO_INCREMENT、主键定义、全部数据行
-- -----------------------------------------------------------------------------
-- 【警告】本脚本包含 DROP DATABASE IF EXISTS，执行会清空同名数据库！
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='配置文件';
...
CREATE TABLE `dictionary` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=26 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='字典';
...
CREATE TABLE `exampaper` (
  ...
  `exampaper_types` int(11) NOT NULL DEFAULT '0' COMMENT '试卷状态',
  `exampaper_delete` int(255) DEFAULT '0' COMMENT '逻辑删除（0代表未删除 1代表已删除）',
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='试卷表';
...
CREATE TABLE `examquestion` (
  ...
  `examquestion_score` int(20) DEFAULT '0' COMMENT '分值',
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='试题表';
...
CREATE TABLE `examrecord` (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='考试记录表';
...
CREATE TABLE `examredetails` (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='答题详情表';
...
CREATE TABLE `examrewrongquestion` (
  ...
  `create_time` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='错题表';
...
-- =============================================================================
-- 8. jiankangzhishi | 健康知识
-- =============================================================================
DROP TABLE IF EXISTS `jiankangzhishi`;
CREATE TABLE `jiankangzhishi` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `jiankangzhishi_name` varchar(200) DEFAULT NULL COMMENT '健康知识名称',
...
CREATE TABLE `token` (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC COMMENT='token表';
...
CREATE TABLE `tongzhi` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `tongzhi_name` varchar(200) DEFAULT NULL COMMENT '通知名称',
...
CREATE TABLE `xinlilaoshi` (
  ...
  `xinlilaoshi_name` varchar(200) DEFAULT NULL COMMENT '心理老师姓名',
...
-- =============================================================================
-- 13. xinlilaoshi_collection | 心理老师收藏
-- =============================================================================
...
-- =============================================================================
-- 15. xinlilaoshi_order | 心理老师预约订单
-- =============================================================================
DROP TABLE IF EXISTS `xinlilaoshi_order`;
CREATE TABLE `xinlilaoshi_order` (
  `id` int(11) NOT NULL AUTO_INCREMENT COMMENT '主键',
  `xinlilaoshi_order_uuid_number` varchar(200) DEFAULT NULL COMMENT '预约流水号',
  `xinlilaoshi_id` int(11) DEFAULT NULL COMMENT '心理老师',
  `yonghu_id` int(11) DEFAULT NULL COMMENT '用户',
  `yuyue_time` date DEFAULT NULL COMMENT '预约日期',
  `shijianduan_types` int(11) DEFAULT NULL COMMENT '预约时间段',
  `xinlilaoshi_order_yesno_types` int(11) DEFAULT NULL COMMENT '预约状态',
  `xinlilaoshi_order_yesno_text` text COMMENT '审核意见',
  `insert_time` timestamp NULL DEFAULT NULL COMMENT '申请时间',
  `create_time` timestamp NULL DEFAULT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='心理老师预约订单';
